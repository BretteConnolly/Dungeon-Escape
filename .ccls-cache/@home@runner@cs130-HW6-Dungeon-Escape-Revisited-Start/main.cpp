...
class Room {
  ...
  void printMe(){ //this method should be called from within your while loop
    
    cout << endl << "Welcome to room " << roomId << endl; // DONE FOR YOU
    
    // TODO : print the description for this room on a single line
...
int main() {
  ...
  // Create new rooms as new "Room" instances on the heap.  
  ...
  // TODO (10 points): Finish constructing new rooms C1, C2, C3, C4, D1, D2, D3, D4, D7, D8 below (there is no room D5 or D6)
  ...
  // TODO (10 points): Finish connecting rooms C1, C2, C3, C4, D1, D2, D3, D4, D7, D8 below (there is no room D5 or D6)
